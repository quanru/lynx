...
class BaseView : public TypeIdentifiable<BaseView>,
 ...
 public:
  ...
  void SetTransform(const lynx::gfx::TransformOperations& ops,
  ...
  lynx::gfx::TransformOperations GetPresentationTransformOps() const;
...
#undef UI_METHOD_LIST_DECLARATION
 ...
 protected:
  ...
  void SetTransformOperations(const lynx::gfx::TransformOperations& value,
  ...
  lynx::gfx::TransformOperations transform_ops_;
  ...
  // Unset inherits; explicit auto overrides an ancestor's none.
  enum class PointerEventsMode : uint8_t { kUnset, kAuto, kNone };
  PointerEventsMode pointer_events_mode_ = PointerEventsMode::kUnset;
